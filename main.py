...
user_item_matrix = pd.pivot_table(train_df, values='Rating', index='UserId', columns='ItemId',fill_value=0)
...
def predict_rating(user_id, item_id, user_item_matrix, cosine_similarity_df):
...
while flag and i < len(users):
    ...
    if len(unrated_items) > 0:
        ...
        predicted_rating = predict_rating(user_id, item_id, user_item_matrix, cosine_similarity_df)
